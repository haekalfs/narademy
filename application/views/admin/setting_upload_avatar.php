		...
		<div id="layoutSidenav_content">
			...
			<div class="row">
                          <div class="col-xl-6">
                                <div class="card mb-4">
									...
									<form action="" method="POST" enctype="multipart/form-data">
										<div>
											...
											<input class="form-control" type="file" name="avatar" id="avatar" accept="image/png, image/jpeg, image/jpg, image/gif">
										</div>
                            ...
                            <div class="col-xl-6">
                                <h4>Upload Avatar</h4><p class="lead">Upload Your Avatar.</p>
                            </div>
                        </div>
				</div>
