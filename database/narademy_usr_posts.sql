...
--
-- Table structure for table `usr_posts`
--

DROP TABLE IF EXISTS `usr_posts`;
...
--
-- Dumping data for table `usr_posts`
--

LOCK TABLES `usr_posts` WRITE;
/*!40000 ALTER TABLE `usr_posts` DISABLE KEYS */;
/*!40000 ALTER TABLE `usr_posts` ENABLE KEYS */;
UNLOCK TABLES;
